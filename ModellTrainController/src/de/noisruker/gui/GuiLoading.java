    ...
    public static void startLocoNet() {
        new Thread(() -> {
            ...
            Platform.runLater(() -> {
                ...
                Objects.requireNonNull(Util.openWindow("/assets/layouts/add_train.fxml", Ref.language.getString("window.add_train"), GUILoader.getPrimaryStage())).setResizable(true);
            });
        }).start();
    }
